...
public class SQLCommand {
    ...
    private static final String UPDATE_OUT_BY_NOPOL = "UPDATE vehicles SET is_out = 1 WHERE is_out = 0 AND nopol = ?;";
    ...
    public static void all(VehicleController vController) throws Exception {
        try {
            conn = JDBCUtil.getConnection();
    ...
    public static void updateIsOut() {
